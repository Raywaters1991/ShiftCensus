...
export function UserProvider({ children }) {
  ...
  // Keep one shared promise so an auth event and an explicit refresh both wait
  // for the same bootstrap instead of one returning early with stale state.
  ...
  async function performLoadUser() {
    ...
    try {
      ...
      // If Supabase itself says the session is invalid, clear auth state. Backend
      // bootstrap errors should not erase an otherwise valid Supabase session.
