...
import DowntimeDashboard from "./components/DowntimeDashboard.jsx";
import "./index.css";
...
export default function App(){
  ...
  if(connectionError&&!isLoginRoute)return <DowntimeDashboard error={connectionError} onRetry={retry} retrying={retrying} onCensus={()=>setOfflineView("census")} onOperations={()=>setOfflineView("operations")}/>;
